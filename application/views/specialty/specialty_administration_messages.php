        ...
        <tr>
            ...
            <td>
              <?php 
                ...
                echo '<a data-message="'.$message['message_text'].'" data-receiver="Администрация" data-sender="'.$message['student_names'].'" title="View full message" class="open-AddBookDialog button_msg" href="#addBookDialog" data-toggle="modal">'.$short_mess.'</a>';
              ?>
            </td>
